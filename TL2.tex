...
De la hoja de datos\footnote{https://www.mouser.com/datasheet/2/68/2n5484-5486-51207.pdf} se obtienen los límites para definir una \textbf{zona de operación segura} de la Figura \ref{fig:zona_segura} dentro de los cuales podremos polarizar al transistor.
...
la resistencia de salida se obtiene pasivando la entrada y colocando una señal de prueba a la salida como muestra la Figura \ref{fig:circuito_ro}, tal que
...
Se propuso un circuito utilizando un JFET en modo source común con el objetivo de obtener una ganancia de potencia mayor a cien. En el cuadro \ref{tab:mediciones} se puede apreciar que en los tres casos se alcanzó este objetivo. Comparando el resultado de $G_p$ predicho teóricamente con el medido, se aprecia una diferencia del 21\%. Se calcula aproximadamente la misma diferencia porcentual al comparar el valor simulado con el obtenido en la práctica.
...
\clearpage
 ...
 \begin{figure}[h!]
        ...
        La frecuencia de oscilación del circuito puede aproximarse según el desfasaje que aportará cada bloque RC. Se puede ver el diagrama de bode de fase de un pasa-altos en la figura \ref{fig:bode}. En la frecuencia de corte $f_c=\frac{1}{2\pi R C}=1.5KHz$ se tiene un desfasaje de 45º, pero se requiere de uno de 90º para que los tres bloques desfasen 180º. Por lo tanto, se puede concluir que la frecuencia de oscilación estará por debajo de la de corte y. según este análisis simplificado, tendra un valor entre 800Hz y 900Hz.
      ...
      \end{figure}
        ...
        Por otro lado, al graficar la FFT mediante LTSpice, presente en la figura \ref{fig:fft}, se puede observar que el armónico predominante se encuentra aproximadamente en 500Hz, pero se tienen otros armónicos presentes también. Consideramos que esto se debe al hecho de estar sumando tres exponenciales para formar una señal cuasi-senoidal, como fue mencionado previamente.
